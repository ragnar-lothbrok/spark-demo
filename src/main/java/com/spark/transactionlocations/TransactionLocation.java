...
public class TransactionLocation {
	...
	public static void main(String[] args) {
		...
		try (JavaSparkContext javaSparkContext = new JavaSparkContext(sparkConf)) {
			...
			Map<Integer, Object> map = transactionPairs.leftOuterJoin(customerPairs).values().distinct()
					.mapToPair(new PairFunction<Tuple2<Integer, Optional<String>>, Integer, String>() {
